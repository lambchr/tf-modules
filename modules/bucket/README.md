...
| Name | Type |
|------|------|
| [aws_s3_object.other](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_object) | resource |
...
| <a name="input_override_default_tags"></a> [override\_default\_tags](#input\_override\_default\_tags) | Ignore provider default\_tags. S3 objects support a maximum of 10 tags. bump | `bool` | `false` | no |
